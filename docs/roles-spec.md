...
7. **Drive CI to green** *(notebook/derived)* — red → **this stage's** executor fixes on the branch (loop; resuming within the stage is correct). **Done = PR open + CI all-green.**
